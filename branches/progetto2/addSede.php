...
<div class = "menuContentBox">
   <!--Contenitore per il menu con i relativi link per le altre pagine del sito-->
	...
	?>
    	<div class = 'titlebox'>Add Sede<br/></div>
        <font color = 'red'>
    <?php
    ...
    ?>
		...
		<form name = 'modify' action = 'saveNuovaSede.php' method = 'POST'>
    	<label>Nome*:</label><br/>
   		<input name = 'nome' rows = 1></textarea><br/><br/>
    	<label>Citt&#224:</label></br>
    	<input name = 'citta' rows = 1></textarea><br/><br/>
        <label>Indirizzo*:</label><br/>
    	<input type= 'text' name = 'indirizzo' /><br/><br/>
        <label>Numero Telefono*:</label><br/>
    	<input type= 'text' name = 'numTelefono' /><br/><br/>		
