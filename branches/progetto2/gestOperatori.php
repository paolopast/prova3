...
<a href="deleteSede.php">deleteSede</a><img src="Pictures/durazzo.jpg" width="100%" height="367px" alt>
...
<div class = "menuContentBox">
   <!--Contenitore per il menu con i relativi link per le altre pagine del sito-->
    ...
    <div class ="content">
		...
		<div class ="buttonBox">
		<button class="action bluebtn" onclick="javascript:document.location='addOperatore.php'"><span class="label">+ Add Operatore</span></button>
            <p>&nbsp;</p>
        </div>
        <?php
		printOperatorMod();
